...
docker run \
    ...
    $RUNTIME \
    ${IMAGE} \
     /bin/bash -c "/tmp/entrypoint.sh; source /home/autoware/pm-autopilot-2.0.1/devel/setup.bash; source /home/autoware/Autoware/install/setup.bash; roslaunch /home/autoware/.config/autoplot_cfg/launch/all.launch;"
